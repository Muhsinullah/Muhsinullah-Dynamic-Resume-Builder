...
//                   placeholder="A Front-End Developer with Proficiency in HTML, CSS, JavaScript, Tailwind CSS, Bootstrap, Next.js, Node for Retail eCommerce, POS and Storage domain & Firebase."
//                   onChange={(event) => {
